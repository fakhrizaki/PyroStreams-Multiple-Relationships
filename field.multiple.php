...
class Field_multiple
{
	...
	public function plugin_override($field, $attributes)
	{
		...
		$this->CI->row_m->sql['where'][] = $this->CI->db->protect_identifiers($join_table.'.row_id', true).'='.$this->CI->db->protect_identifiers($join_stream->stream_prefix.$join_stream->stream_slug.'.id', true);
